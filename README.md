...
* TODO: To allow bots to use first aid mounted on the wall or `func_healthcharger` - In Progress
...
- Rich Geldreich : Mini compression for visibility and learned data