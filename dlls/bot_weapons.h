...
public:
	...
	int HudSlot(void) const
	{
		return m_iHudSlot;
	}

	int HudPosition(void) const
	{
...
public:
	...
	BOOL CanGetMorePrimaryAmmo(void) const
	{
		switch (m_iId)
		{
		case NS_WEAPON_MINE:
